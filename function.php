...
public $site_banner = '<div class="ads"><a target="_blank" href="http://lmasat.tk/mp3quran"><img alt="Muslim Library" src="images/muslim-library.gif" /></a></div>';
public $site_author = 'lmasat.tk';
public $site_js = '';
...
$word['description'] = 'المكتبة الصوتية للقرآن الكريم موقع ديني تم تطويرة بوساطه المرتجل لعله سبيل في نشر الاسلام وربنا يتقبل منا ومنكم';
$word['home'] = 'الرئيسية';
$word['download'] = 'تحميل السورة';
$word['footer'] = '<p>برمجة <a target="_blank" href="https://t.me/Almortagel_12">المرتجل</a> - بدعم من <a target="_blank" title="mp3quran.net" href="http://www.mp3quran.net">MP3 Quran API</a> الحقوق محفوظة '.date('Y',time()).'</p>';
...
$word['footer'] = '<p>Programming by <a target="_blank" href="https://t.me/Almortagel_12">Almortagel</a>, Copyright '.date('Y',time()).' <a target="_blank" title="mp3quran.net" href="http://www.mp3quran.net">MP3 Quran API</a>,All Rights Reserved.</p>';
...
$word['home'] = 'الرئيسية';
$word['download'] = 'تحميل السورة';
$word['footer'] = '<p>برمجة <a target="_blank" href="https://t.me/Almortagel_12">قناة عالم البرمجه</a> - بدعم من <a target="_blank" title="mp3quran.net" href="http://www.mp3quran.net">MP3 Quran API</a> الحقوق محفوظة '.date('Y',time()).'</p>';
$word['nothing'] = 'لايوجد قاريء';
$word['reciters'] = 'القرّاء';
$word['reciters_by_letter'] = 'ترتيب القرّاء أبجديا';
$word['reciters_by_rewaya'] = 'ترتيب القرّاء حسب الرواية';
